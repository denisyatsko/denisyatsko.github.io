...
$(document).ready(function(){$("#fullpage").fullpage({anchors:["firstPage","secondPage","3rdPage","4thpage"],menu:"#menu",css3:!0,scrollingSpeed:900}),new TypeIt(".bottom_text",{strings:["frontend developer, sunbeam and realistic optimist"],speed:50,startDelay:2300,autoStart:!1}),$(".my_photo_wrapper").hover(function(){$(".my_photo_wrapper h2").animate({opacity:1},"slow")})});